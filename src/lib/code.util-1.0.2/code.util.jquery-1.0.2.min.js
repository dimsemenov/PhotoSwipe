...
// version: 1.0.2
(function(e){if(!Function.prototype.bind)Function.prototype.bind=function(b){var a=[].slice,d=a.call(arguments,1),c=this,e=function(){},f=function(){return c.apply(this instanceof e?this:b||{},d.concat(a.call(arguments)))};e.prototype=c.prototype;f.prototype=new e;return f};if(typeof e.Code==="undefined")e.Code={};e.Code.Util={registerNamespace:function(){var b=arguments,a=null,d,c,g;for(d=0;d<b.length;d++){g=b[d];g=g.split(".");a=g[0];typeof e[a]==="undefined"&&(e[a]={});a=e[a];for(c=1;c<g.length;++c)a[g[c]]=
a[g[c]]||{},a=a[g[c]]}},coalesce:function(){var b;for(b=0;b<arguments.length;b++)if(!this.isNothing(arguments[b]))return arguments[b];return null},extend:function(b,a,d){var c;this.isNothing(d)&&(d=!0);if(b&&a&&this.isObject(a))for(c in a)this.objectHasProperty(a,c)&&(d?b[c]=a[c]:typeof b[c]==="undefined"&&(b[c]=a[c]))},clone:function(b){var a={};this.extend(a,b);return a},isObject:function(b){return b instanceof Object},isFunction:function(b){return{}.toString.call(b)==="[object Function]"},isArray:function(b){return b instanceof
Array},isLikeArray:function(b){return typeof b.length==="number"},isNumber:function(b){return typeof b==="number"},isString:function(b){return typeof b==="string"},isNothing:function(b){if(typeof b==="undefined"||b===null)return!0;return!1},swapArrayElements:function(b,a,d){var c=b[a];b[a]=b[d];b[d]=c},trim:function(b){return b.replace(/^\s\s*/,"").replace(/\s\s*$/,"")},toCamelCase:function(b){return b.replace(/(\-[a-z])/g,function(a){return a.toUpperCase().replace("-","")})},toDashedCase:function(b){return b.replace(/([A-Z])/g,
function(a){return"-"+a.toLowerCase()})},arrayIndexOf:function(b,a){var d,c;c=-1;for(d=0;d<a.length;d++)if(a[d]===b){c=d;break}return c},objectHasProperty:function(b,a){return b.hasOwnProperty?b.hasOwnProperty(a):"undefined"!==typeof b[a]}}})(window);
...
"TimingFunction"]="";d[this._transitionPrefix+"Delay"]="";d[this._transformLabel]="";b.DOM.setStyle(a,d)}else b.isNothing(e.jQuery)||e.jQuery(a).stop(!0,!0)},fadeIn:function(a,d,c,g){if(d<=0&&(b.DOM.setStyle(a,"opacity",1),!b.isNothing(c))){c(a);return}b.DOM.getStyle(a,"opacity")>=1&&b.DOM.setStyle(a,"opacity",0);b.Browser.isCSSTransformSupported?this._applyTransition(a,"opacity",1,d,c,g):b.isNothing(e.jQuery)||e.jQuery(a).fadeTo(d,1,c)},fadeOut:function(a,d,c,g){if(d<=0&&(b.DOM.setStyle(a,"opacity",
0),!b.isNothing(c))){c(a);return}b.Browser.isCSSTransformSupported?this._applyTransition(a,"opacity",0,d,c,g):e.jQuery(a).fadeTo(d,0,c)},slideBy:function(a,d,c,g,f,i){var h={},d=b.coalesce(d,0),c=b.coalesce(c,0),i=b.coalesce(i,"ease-out");h[this._transitionPrefix+"Property"]="all";h[this._transitionPrefix+"Delay"]="0";g===0?(h[this._transitionPrefix+"Duration"]="",h[this._transitionPrefix+"TimingFunction"]=""):(h[this._transitionPrefix+"Duration"]=g+"ms",h[this._transitionPrefix+"TimingFunction"]=
b.coalesce(i,"ease-out"),b.Events.add(a,this._transitionEndLabel,this._getTransitionEndHandler()));h[this._transformLabel]=b.Browser.is3dSupported?"translate3d("+d+"px, "+c+"px, 0px)":"translate("+d+"px, "+c+"px)";if(!b.isNothing(f))a.cclallcallback=f;b.DOM.setStyle(a,h);g===0&&e.setTimeout(function(){this._leaveTransforms(a)}.bind(this),this._applyTransitionDelay)},resetTranslate:function(a){var d={};d[this._transformLabel]=d[this._transformLabel]=b.Browser.is3dSupported?"translate3d(0px, 0px, 0px)":
"translate(0px, 0px)";b.DOM.setStyle(a,d)},_applyTransition:function(a,d,c,g,f,i){var h={},i=b.coalesce(i,"ease-in");h[this._transitionPrefix+"Property"]=d;h[this._transitionPrefix+"Duration"]=g+"ms";h[this._transitionPrefix+"TimingFunction"]=i;h[this._transitionPrefix+"Delay"]="0";b.Events.add(a,this._transitionEndLabel,this._getTransitionEndHandler());b.DOM.setStyle(a,h);b.isNothing(f)||(a["ccl"+d+"callback"]=f);e.setTimeout(function(){b.DOM.setStyle(a,d,c)},this._applyTransitionDelay)},_onTransitionEnd:function(a){b.Events.remove(a.currentTarget,
this._transitionEndLabel,this._getTransitionEndHandler());this._leaveTransforms(a.currentTarget)},_leaveTransforms:function(a){var d=a.style[this._transitionPrefix+"Property"],c=d!==""?"ccl"+d+"callback":"cclallcallback",g,d=b.coalesce(a.style.webkitTransform,a.style.MozTransform,a.style.transform),f,i=e.parseInt(b.DOM.getStyle(a,"left"),0),h=e.parseInt(b.DOM.getStyle(a,"top"),0),k,l,j={};d!==""&&(d=b.Browser.is3dSupported?d.match(/translate3d\((.*?)\)/):d.match(/translate\((.*?)\)/),b.isNothing(d)||
(f=d[1].split(", "),k=e.parseInt(f[0],0),l=e.parseInt(f[1],0)));j[this._transitionPrefix+"Property"]="";j[this._transitionPrefix+"Duration"]="";j[this._transitionPrefix+"TimingFunction"]="";j[this._transitionPrefix+"Delay"]="";b.DOM.setStyle(a,j);e.setTimeout(function(){if(!b.isNothing(f))j={},j[this._transformLabel]="",j.left=i+k+"px",j.top=h+l+"px",b.DOM.setStyle(a,j);b.isNothing(a[c])||(g=a[c],delete a[c],g(a))}.bind(this),this._applyTransitionDelay)}}})})(window,window.Code.Util);
