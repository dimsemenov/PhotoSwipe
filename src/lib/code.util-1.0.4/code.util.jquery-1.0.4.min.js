...
this.is3dSupported=!b.isNothing(a.style.WebkitPerspective);this.isCSSTransformSupported=!b.isNothing(a.style.WebkitTransform)||!b.isNothing(a.style.MozTransform)||!b.isNothing(a.style.transformProperty);this.isTouchSupported=this.isEventSupported("touchstart");this.isGestureSupported=this.isEventSupported("gesturestart")},_eventTagNames:{select:"input",change:"input",submit:"form",reset:"form",error:"img",load:"img",abort:"img"},isEventSupported:function(a){var d=document.createElement(this._eventTagNames[a]||
"div"),c,a="on"+a;c=b.objectHasProperty(d,a);c||(d.setAttribute(a,"return;"),c=typeof d[a]==="function");return c}};b.Browser._detect()})(window,window.Code.Util);
